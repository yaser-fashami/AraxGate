...
using SinaOTOS.Services.ApplicationServices;
using SinaOTOS.Services.Billing;
using Microsoft.Extensions.Configuration;
using Microsoft.AspNetCore.Hosting;
using Microsoft.EntityFrameworkCore.Metadata;

namespace SinaOTOS.ServicesTest;
...
public class InvoiceCalculatorTest
{
    ...
    public InvoiceCalculatorTest(IAppVersionService appVersionService)
    {
        ...
        var options = new DbContextOptionsBuilder<SinaOTOSDbContext>()
            .UseSqlServer("Server=.; Initial Catalog=SinaOTOSDB; User ID=sa; Password=1qaz!QAZ; Encrypt=false;")
            .Options;

        var ctx = new SinaOTOSDbContext(options);
